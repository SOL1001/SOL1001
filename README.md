...
### Software Developer | Backend Architecture | ERP & Payment Systems
...
- 💼 **Full-Stack Developer** at *Guba Technology* (Sep 2024 - Oct 2025) — Architected large-scale ERPs (Gift Real Estate, Defence Force).
- 💼 **Full-Stack Developer** at *AddisPay* (Jun 2023 - Sep 2024) — Designed checkout services and multi-bank payment systems.
...
### [Ethiopian Tourism Commission ERP](#) 
🏢 Custom ERP covering HR, finance, and asset tracking (Frappe, Python, MariaDB)

### [Gift Real Estate ERP & Sales Platform](#) 
🏠 End-to-end real estate ERP with property listings and financial dashboards (Frappe, React)
